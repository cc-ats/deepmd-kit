...
class DescrptSeR (AbstractDescrpt):
    ...
    def init_param_jdata(cls, jdata):
        ...
        filter_activation_fn = class_data['activation_function']
        filter_precision     = class_data['precision']
        ...
        return cls( sel_a, 
                     rcut                = rcut_r,
                     rcut_smth           = rcut_r_smth,
                     neuron              = filter_neuron,
                     axis_neuron         = n_axis_neuron,
                     ...
                     activation_function = filter_activation_fn,
